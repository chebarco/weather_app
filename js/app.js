...
form.addEventListener("submit", (e) => {
  ...
  fetch(url)
   ...
   iframe.src = "https://www.google.com/maps/embed/v1/place?key=" + apiKeyMap + "&q="+ name;
...
// const searchMap = (description) => {
//   fetch("" + description)
//     .then((response) => response.json())
//     .then((data) => {
//       // elementoVideo.innerHTML = `<img src = "${main.snippet.thumbnails.default.url}">`;
//     })
//     .catch(function (err) {
//       console.log("Something went wrong", err);
//     });
